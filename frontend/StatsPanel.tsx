    ...
    <div className={`space-y-6 ${className}`}>
      ...
      <div className="bg-card rounded-2xl p-6 border border-border space-y-4">
        ...
        <div className="flex items-center justify-between p-4 bg-muted/20 rounded-xl">
          <div>
            <p className="text-xs text-muted-foreground mb-1">Total Intake</p>
            <p className="text-2xl font-bold text-foreground">{totalIntake.toLocaleString()}k</p>
          </div>
        ...
        <div className="flex items-center justify-between p-4 bg-muted/20 rounded-xl">
          ...
          <div className="h-12 w-12 bg-gradient-cyan rounded-xl flex items-center justify-center">
            <span className="text-xl">👥</span>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between p-4 bg-muted/20 rounded-xl">
          <div>
            ...
            <p className="text-2xl font-bold text-foreground">{repeatCustomers.toLocaleString()}k</p>
          </div>
          <div className="h-12 w-12 bg-gradient-yellow rounded-xl flex items-center justify-center">
            <span className="text-xl">🔄</span>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between p-4 bg-muted/20 rounded-xl">
          ...
          <div className="h-12 w-12 bg-gradient-green rounded-xl flex items-center justify-center">
            <span className="text-xl">💰</span>
          </div>
        </div>
      </div>
      ...
      <div className="bg-card rounded-2xl p-6 border border-border space-y-4">
        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-sm font-semibold text-foreground">20k</span>
          </div>
        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-sm font-semibold text-foreground">7k</span>
          </div>
          <div className="h-2 bg-muted/20 rounded-full overflow-hidden">
            <div 
