...
import { Calculator, TrendingUp, Bot, Code, Star, Target, Crown, ArrowRight, Lock } from "lucide-react"
          ...
          <Card className="bg-gradient-card shadow-card border-border">
            ...
            <CardContent className="space-y-4">
              ...
              <Button 
                className="w-full" 
                size="lg"
                onClick={() => downloadProposal(services, calculations)}
              >
...
// Função para download da proposta
const downloadProposal = (services: ServiceState, calculations: any) => {
  const content = `
