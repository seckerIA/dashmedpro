...
export const MEDICAL_SPECIALTIES = [
  ...
  { value: 'nutrologia', label: 'Nutrologia', emoji: '🥗', color: 'from-lime-500 to-green-500' },
  { value: 'endocrinologia', label: 'Endocrinologia', emoji: '🔬', color: 'from-orange-500 to-amber-500' },
